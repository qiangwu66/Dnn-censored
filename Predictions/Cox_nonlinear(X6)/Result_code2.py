...
DMS_path = os.path.join(output_folder, "DMS_Coxnonlinear.csv")
...
ibs_path = os.path.join(output_folder, "IBS_Coxnonlinear.csv")
...
run_time_path = os.path.join(output_folder, "run_time_Coxnonlinear.csv")
...
for k in range(10):
    ...
    fig1 = plt.figure() 
    fig1.suptitle(f'Cox (nonlinear), $X = {formatted_row}$', fontsize=8)
    # -----n=400, X-----
    ...
    file_name = os.path.join(subfolder, f'Case2_fig_{k}.jpeg') 
