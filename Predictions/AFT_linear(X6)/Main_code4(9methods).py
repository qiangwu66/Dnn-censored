...
for k in range(10):
    ...
    ax1_2.plot(t_fig, St_PAFT_X_400[:, k], color='red', label='PAFT', linestyle='--')
    ...
    file_name = os.path.join(subfolder, f'Nine_Case4_fig_{k}.jpeg')  
