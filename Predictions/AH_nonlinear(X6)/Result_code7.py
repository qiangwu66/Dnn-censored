...
DMS_path = os.path.join(output_folder, "DMS_AHnonlinear.csv")
...
ibs_path = os.path.join(output_folder, "IBS_AHnonlinear.csv")
...
run_time_path = os.path.join(output_folder, "run_time_AHnonlinear.csv")
...
for k in range(10):
    ...
    fig1 = plt.figure() 
    fig1.suptitle(f'AH (nonlinear), $X = {formatted_row}$', fontsize=8)
    # -----n=400, X-----
    ...
    file_name = os.path.join(subfolder, f'Case7_fig_{k}.jpeg')  
