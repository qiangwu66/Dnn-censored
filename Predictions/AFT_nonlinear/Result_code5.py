...
DMS_path = os.path.join(output_folder, "DMS_AFTnonlinear.csv")
...
ibs_path = os.path.join(output_folder, "IBS_AFTnonlinear.csv")
...
run_time_path = os.path.join(output_folder, "run_time_AFTnonlinear.csv")
...
for k in range(10):
    ...
    fig1 = plt.figure() 
    fig1.suptitle(f'AFT (nonlinear), $X = {formatted_row}$', fontsize=8) 
    # -----n=400, X-----
    ...
    file_name = os.path.join(subfolder, f'Case5_fig_{k}.jpeg') 
