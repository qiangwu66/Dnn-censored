...
# -------training data1: 40%  validation data1: 10%  training data2: 40% validation data2: 10% -----------------------
# ---training data1: 3642
...
X_R_valid2 = X_R[np.arange(8194, 9104)]
De_R_valid2 = De_R[np.arange(8194, 9104)]
Time_R_valid2 = Time_R[np.arange(8194, 9104)]
...
T_w_n = np.sqrt(7284) * np.mean(polled_data['De'] * I_T_T_mean * (g1_T_X_n - g0_T_X_n_non))
