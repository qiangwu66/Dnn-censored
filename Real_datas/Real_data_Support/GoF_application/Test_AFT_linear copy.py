...
#----------------------------------------------------------
tau = 1
Dnn_layer1_all = [1, 2, 3]
Dnn_node1_all = [20, 30, 40, 50]
Dnn_lr1_all = [1e-4, 5e-4, 1e-3]
Dnn_epoch = 1000
patiences = 10
m = 3
...
#--------------------------------------------------------
for Dnn_layer1 in Dnn_layer1_all:
            for Dnn_node1 in Dnn_node1_all:
                 for Dnn_lr1 in Dnn_lr1_all:  
                   ...
                   size_DNN_path = os.path.join(output_folder, f"Coxlinear_p_value-{Dnn_layer1}-{Dnn_node1}-{Dnn_lr1}.csv")
