...
Est_dnn = g_dnn_agq(X_R_train, De_R_train, Time_R_train, X_R_valid, De_R_valid, Time_R_valid, X_R_test, Time_R_test, s_k, Dnn_layer, Dnn_node, Dnn_lr, Dnn_epoch, patiences, agq_n_low=32, agq_n_high=64, agq_tol=1e-6, agq_max_subdiv=20, clamp_exp_max=None)
...
ibs_path = os.path.join(output_folder, f"IBS_realdata_DNN_AGQ.csv")
