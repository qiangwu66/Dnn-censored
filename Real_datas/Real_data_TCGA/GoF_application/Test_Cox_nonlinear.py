...
# ---validation data1: 74
X_R_valid1 = X_R[np.arange(588, 662)]
De_R_valid1 = De_R[np.arange(588, 662)]
Time_R_valid1 = Time_R[np.arange(588, 662)]
# ---validation data2: 74
X_R_valid2 = X_R[np.arange(662, 736)]
De_R_valid2 = De_R[np.arange(662, 736)]
Time_R_valid2 = Time_R[np.arange(662, 736)]
...
T_w_n = np.sqrt(588) * np.mean(polled_data['De'] * I_T_T_mean * (g1_T_X_n - g0_T_X_n_non))
