...
# split samples via gender
df_female = X_variables[X_variables[:,1] == 0]
df_male = X_variables[X_variables[:,1] == 1]

X_female = np.delete(df_female, 1, axis=1)
X_male = np.delete(df_male, 1, axis=1)

Time_female = Time[X_variables[:,1] == 0]
Time_male = Time[X_variables[:,1] == 1]

De_female = De[X_variables[:,1] == 0]
De_male = De[X_variables[:,1] == 1]
