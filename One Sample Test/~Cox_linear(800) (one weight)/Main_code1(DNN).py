...
def process_results(results):
    ...
    T_Sigma_1_Cox_new = np.array(T_Sigma_1_Cox_new)
    T_Sigma_2_Cox_new = np.array(T_Sigma_2_Cox_new)
    T_Sigma_3_Cox_new = np.array(T_Sigma_3_Cox_new)
    T_Sigma_4_Cox_new = np.array(T_Sigma_4_Cox_new)
    T_Sigma_1_AFT_new = np.array(T_Sigma_1_AFT_new)
    T_Sigma_2_AFT_new = np.array(T_Sigma_2_AFT_new)
    T_Sigma_3_AFT_new = np.array(T_Sigma_3_AFT_new)
    T_Sigma_4_AFT_new = np.array(T_Sigma_4_AFT_new)
    T_Sigma_1_AH_new = np.array(T_Sigma_1_AH_new)
    T_Sigma_2_AH_new = np.array(T_Sigma_2_AH_new)
    T_Sigma_3_AH_new = np.array(T_Sigma_3_AH_new)
    T_Sigma_4_AH_new = np.array(T_Sigma_4_AH_new)
...
fig1.suptitle(r"QQ-Plots under Cox model", fontsize=10) 
...
res1 = stats.probplot(T_Sigma_1_Cox_B, dist="norm", plot=ax1_1)
res2 = stats.probplot(T_Sigma_2_Cox_B, dist="norm", plot=ax1_2)
res3 = stats.probplot(T_Sigma_3_Cox_B, dist="norm", plot=ax1_3)
res4 = stats.probplot(T_Sigma_4_Cox_B, dist="norm", plot=ax1_4)
...
fig1.savefig("qq_plot_Cox.pdf", dpi=600)
