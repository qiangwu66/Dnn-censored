...
import random
import torch
from data_generator import generate_Cox_2
...
def single_simulation(b, n, Dnn_layer1, Dnn_node1, Dnn_lr1, Dnn_epoch, patiences, tau, corr, t_nodes, m, nodevec):
    ...
    set_seed(490 + b)
    # --------------g1(t,x)-------------
    Data_all = generate_Cox_2(n, corr, tau)
...
size_DNN_path = os.path.join(output_folder, f"CoxII-size_DNN-{Dnn_layer1}-{Dnn_node1}-{Dnn_lr1}.csv")
