...
#%% ---------------- power c1 = 0.125, 0.25, 0.5--------------------------
c1 = 0.5

# N1
Data_N1 = generate_Cox_1(2000, corr, tau)
De_N1 = Data_N1['De']
f_X_N1 = Data_N1['f_X']
Y_N1 = Data_N1['T_O']

# N2
Data_N2 = generate_Cox_2_nocross(2000, corr, tau, c1)
De_N2 = Data_N2['De']
f_X_N2 = Data_N2['f_X']
Y_N2 = Data_N2['T_O']
...
# g1,S1
g1_true_N1 = np.log(((Y_N1 + 0.001) / 3) * np.exp(f_X_N1)) 
g1_true_N2 = np.log(((Y_N2 + 0.001) / 3) * np.exp(f_X_N2))

S1_true_N1 = np.exp(- ((Y_N1 + 0.001) ** 2 / 6 - 0.001 ** 2 / 6) * np.exp(f_X_N1)) 
S1_true_N2 = np.exp(- ((Y_N2 + 0.001) ** 2 / 6 - 0.001 ** 2 / 6) * np.exp(f_X_N2))
...
# g2,S2
g2_true_N1 = np.log(((Y_N1 + 0.001) / 3) * np.exp(f_X_N1)) + c1 
g2_true_N2 = np.log(((Y_N2 + 0.001) / 3) * np.exp(f_X_N2)) + c1

S2_true_N1 = np.exp(- ((Y_N1 + 0.001) ** 2 / 6 - 0.001 ** 2 / 6) * np.exp(f_X_N1 + c1)) 
S2_true_N2 = np.exp(- ((Y_N2 + 0.001) ** 2 / 6 - 0.001 ** 2 / 6) * np.exp(f_X_N2 + c1))
...
Data_gene = generate_Cox_1(5000, corr, tau)
X_gene = Data_gene['X'] 
...
S2_t_X_gene_N1 = np.exp(- ((Y_N1[:,np.newaxis] + 0.001) ** 2 / 6 - 0.001 ** 2 / 6) * np.exp(f_X_gene + c1))
S2_t_X_gene_N2 = np.exp(- ((Y_N2[:,np.newaxis] + 0.001) ** 2 / 6 - 0.001 ** 2 / 6) * np.exp(f_X_gene + c1))

E_S_N1 = np.mean(S2_t_X_gene_N1, axis=1) 
E_I_C_T_N1 =  np.mean(Indicator_matrix(C_gene, Y_N1), axis=0) 

E_S_N2 = np.mean(S2_t_X_gene_N2, axis=1) 
E_I_C_T_N2 =  np.mean(Indicator_matrix(C_gene, Y_N2), axis=0) 


W_1_N1 = E_S_N1 * E_I_C_T_N1 
W_2_N1 = E_S_N1 * E_I_C_T_N1 * S2_true_N1 
W_3_N1 = E_S_N1 * E_I_C_T_N1 * np.sqrt(S2_true_N1 * (1-S2_true_N1)) 
W_4_N1 = E_S_N1 * E_I_C_T_N1 * S2_true_N1 * (1-S2_true_N1) 


W_1_N2 = E_S_N2 * E_I_C_T_N2 
W_2_N2 = E_S_N2 * E_I_C_T_N2 * S2_true_N2 
W_3_N2 = E_S_N2 * E_I_C_T_N2 * np.sqrt(S2_true_N2 * (1-S2_true_N2)) 
W_4_N2 = E_S_N2 * E_I_C_T_N2 * S2_true_N2 * (1-S2_true_N2) 
...
Lambda_T_nodes = (T_nodes + 0.001) ** 2 / 6 - 0.001 ** 2 / 6
E_I_C_T_nodes =  np.mean(Indicator_matrix(C_gene, T_nodes), axis=0)


I_T_T_nodes_N1 = Indicator_matrix(Y_N1, T_nodes) 
g1_T_nodes_X_N1 = np.log((T_nodes.reshape(-1, 1) + 0.001) / 3) + f_X_N1.reshape(1, -1) 
g1_T_nodes_X_N2 = np.log((T_nodes.reshape(-1, 1) + 0.001) / 3) + f_X_N2.reshape(1, -1) 
S1_T_nodes_X_gene = np.exp(-Lambda_T_nodes[:,np.newaxis] * np.exp(f_X_gene)) 
E_S1_T_nodes = np.mean(S1_T_nodes_X_gene, axis=1) 
S1_T_nodes_X_N1 = np.exp(-Lambda_T_nodes[:,np.newaxis] * np.exp(f_X_N1)) 
S1_T_nodes_X_N2 = np.exp(-Lambda_T_nodes[:,np.newaxis] * np.exp(f_X_N2)) 
...
g2_T_nodes_X_N1 = np.log((T_nodes.reshape(-1, 1) + 0.001) / 3) + f_X_N1.reshape(1, -1) + c1 
g2_T_nodes_X_N2 = np.log((T_nodes.reshape(-1, 1) + 0.001) / 3) + f_X_N2.reshape(1, -1) + c1 
S2_T_nodes_X_gene = np.exp(-Lambda_T_nodes[:,np.newaxis] * np.exp(f_X_gene + c1)) 
E_S2_T_nodes = np.mean(S2_T_nodes_X_gene, axis=1) 
S2_T_nodes_X_N1 = np.exp(-Lambda_T_nodes[:,np.newaxis] * np.exp(f_X_N1 + c1)) 
S2_T_nodes_X_N2 = np.exp(-Lambda_T_nodes[:,np.newaxis] * np.exp(f_X_N2 + c1)) 
...
W_T_nodes_2_N1 =  np.tile((E_S1_T_nodes * E_I_C_T_nodes)[:, np.newaxis], (1, 2000)) * S2_T_nodes_X_N1 
W_T_nodes_3_N1 =  np.tile((E_S1_T_nodes * E_I_C_T_nodes)[:, np.newaxis], (1, 2000)) * np.sqrt(S2_T_nodes_X_N1 * (1 - S2_T_nodes_X_N1)) 
W_T_nodes_4_N1 =  np.tile((E_S1_T_nodes * E_I_C_T_nodes)[:, np.newaxis], (1, 2000)) * S2_T_nodes_X_N1 * (1 - S2_T_nodes_X_N1) 


W_T_nodes_1_N2 =  np.tile((E_S1_T_nodes * E_I_C_T_nodes)[:, np.newaxis], (1, 2000)) 
W_T_nodes_2_N2 =  np.tile((E_S1_T_nodes * E_I_C_T_nodes)[:, np.newaxis], (1, 2000)) * S2_T_nodes_X_N2 
W_T_nodes_3_N2 =  np.tile((E_S1_T_nodes * E_I_C_T_nodes)[:, np.newaxis], (1, 2000)) * np.sqrt(S2_T_nodes_X_N2 * (1 - S2_T_nodes_X_N2)) 
W_T_nodes_4_N2 =  np.tile((E_S1_T_nodes * E_I_C_T_nodes)[:, np.newaxis], (1, 2000)) * S2_T_nodes_X_N2 * (1 - S2_T_nodes_X_N2) 
...
Power_1 = 1 - norm.cdf((np.sqrt(2 * (sigma_1w_1 ** 2 + sigma_2w_1 ** 2)) * 1.96 - np.sqrt(1600) * Eta_1) / np.sqrt((1/2) * (sigma_1w_g1g2_1 ** 2 + sigma_2w_g1g2_1 ** 2))) + norm.cdf((-np.sqrt(2 * (sigma_1w_1 ** 2 + sigma_2w_1 ** 2)) * 1.96 - np.sqrt(1600) * Eta_1) / np.sqrt((1/2) * (sigma_1w_g1g2_1 ** 2 + sigma_2w_g1g2_1 ** 2)))

Power_2 = 1 - norm.cdf((np.sqrt(2 * (sigma_1w_2 ** 2 + sigma_2w_2 ** 2)) * 1.96 - np.sqrt(1600) * Eta_2) / np.sqrt((1/2) * (sigma_1w_g1g2_2 ** 2 + sigma_2w_g1g2_2 ** 2))) + norm.cdf((-np.sqrt(2 * (sigma_1w_2 ** 2 + sigma_2w_2 ** 2)) * 1.96 - np.sqrt(1600) * Eta_2) / np.sqrt((1/2) * (sigma_1w_g1g2_2 ** 2 + sigma_2w_g1g2_2 ** 2)))

Power_3 = 1 - norm.cdf((np.sqrt(2 * (sigma_1w_3 ** 2 + sigma_2w_3 ** 2)) * 1.96 - np.sqrt(1600) * Eta_3) / np.sqrt((1/2) * (sigma_1w_g1g2_3 ** 2 + sigma_2w_g1g2_3 ** 2))) + norm.cdf((-np.sqrt(2 * (sigma_1w_3 ** 2 + sigma_2w_3 ** 2)) * 1.96 - np.sqrt(1600) * Eta_3) / np.sqrt((1/2) * (sigma_1w_g1g2_3 ** 2 + sigma_2w_g1g2_3 ** 2)))


Power_4 = 1 - norm.cdf((np.sqrt(2 * (sigma_1w_4 ** 2 + sigma_2w_4 ** 2)) * 1.96 - np.sqrt(1600) * Eta_4) / np.sqrt((1/2) * (sigma_1w_g1g2_4 ** 2 + sigma_2w_g1g2_4 ** 2))) + norm.cdf((-np.sqrt(2 * (sigma_1w_4 ** 2 + sigma_2w_4 ** 2)) * 1.96 - np.sqrt(1600) * Eta_4) / np.sqrt((1/2) * (sigma_1w_g1g2_4 ** 2 + sigma_2w_g1g2_4 ** 2)))


result_size_DNN_new = pd.DataFrame(
    np.array([Power_1, Power_2, Power_3, Power_4])
    )
size_DNN_path_new = f"result_True_power_Cox_nocross_{c1}.csv"
