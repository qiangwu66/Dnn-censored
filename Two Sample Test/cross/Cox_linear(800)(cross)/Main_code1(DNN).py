...
def single_simulation(b, n, Dnn_layer1, Dnn_node1, Dnn_lr1, Dnn_layer2, Dnn_node2, Dnn_lr2, Dnn_epoch, patiences, tau, corr):
    ...
    # --------------g2(t,x)-------------
    Data2_all = generate_Cox_2_cross(n, corr, tau) 
...
size_DNN_path = os.path.join(output_folder, f"cross_Cox-size_DNN-{Dnn_layer1}-{Dnn_node1}-{Dnn_lr1}-{Dnn_layer2}-{Dnn_node2}-{Dnn_lr2}.csv")
